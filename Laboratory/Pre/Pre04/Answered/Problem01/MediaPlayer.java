            ...
            try {
                switch (action) {
                    ...
                    case "MOVIE_IS_PLAYING":
                        if (movie != null)
                            System.out.println("Playing: " + movie.isPlaying());
                        break;

                    case "MOVIE_START_DOWNLOAD":
                        if (movie != null)
                            System.out.println("Download started: " + movie.startDownload());
                        break;

                    case "MOVIE_GET_PROGRESS":
                        if (movie != null)
                            System.out.println("Progress: " + movie.getDownloadProgress() + "%");
                        break;
                    ...
                    case "MOVIE_GET_FILE_SIZE":
                        if (movie != null)
                            System.out.println("File size: " + movie.getFileSize());
                        break;

                    case "MOVIE_IS_COMPLETE":
                        if (movie != null)
                            System.out.println("Download complete: " + movie.isDownloadComplete());
                        break;

                    case "MOVIE_GET_PATH":
                        if (movie != null)
                            System.out.println("Path: " + movie.getDownloadPath());
                        break;
                    ...
                    case "PODCAST_GET_DURATION":
                        if (podcast != null)
                            System.out.println("Duration: " + podcast.getDuration());
                        break;
                    ...
                    case "PODCAST_IS_PLAYING":
                        if (podcast != null)
                            System.out.println("Playing: " + podcast.isPlaying());
                        break;

                    case "PODCAST_START_DOWNLOAD":
                        if (podcast != null)
                            System.out.println("Download started: " + podcast.startDownload());
                        break;

                    case "PODCAST_GET_PROGRESS":
                        if (podcast != null)
                            System.out.println("Progress: " + podcast.getDownloadProgress() + "%");
                        break;
                    ...
                    case "PODCAST_GET_FILE_SIZE":
                        if (podcast != null)
                            System.out.println("File size: " + podcast.getFileSize());
                        break;

                    case "PODCAST_IS_COMPLETE":
                        if (podcast != null)
                            System.out.println("Download complete: " + podcast.isDownloadComplete());
                        break;

                    case "PODCAST_GET_PATH":
                        if (podcast != null)
                            System.out.println("Path: " + podcast.getDownloadPath());
                        break;
                    ...
                    case "LIVE_GET_DURATION":
                        if (liveStream != null)
                            System.out.println("Duration: " + liveStream.getDuration());
                        break;
                    ...
                    case "LIVE_IS_PLAYING":
                        if (liveStream != null)
                            System.out.println("Playing: " + liveStream.isPlaying());
                        break;

                    case "LIVE_IS_LIVE":
                        if (liveStream != null)
                            System.out.println("Is live: " + liveStream.isLive());
                        break;

                    case "LIVE_GET_STREAMER":
                        if (liveStream != null)
                            System.out.println("Streamer: " + liveStream.getStreamerName());
                        break;

                    case "LIVE_GET_VIEWERS":
                        if (liveStream != null)
                            System.out.println("Viewers: " + liveStream.getViewerCount());
                        break;

                    case "LIVE_UPDATE_VIEWERS":
                        if (liveStream != null)
                            liveStream.updateViewerCount();
                        break;
