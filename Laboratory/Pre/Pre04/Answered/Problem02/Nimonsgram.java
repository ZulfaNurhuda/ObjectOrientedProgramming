public class Nimonsgram {
    ...
    public static void main(String[] args) {
        ...
        // PhotoPost px = new PhotoPost("daev_karambol", "shooting day", 5, false,
        // true);
    ...
    private static String classAndAuthor(Object o) {
        if (o instanceof PhotoPost p)
            return "PhotoPost by @" + p.getAuthor();
        if (o instanceof VideoPost v)
            return "VideoPost by @" + v.getAuthor();
