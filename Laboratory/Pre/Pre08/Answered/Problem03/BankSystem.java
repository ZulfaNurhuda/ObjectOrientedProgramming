public class BankSystem {
    ...
    /* TODO : Lengkapi method addAccount(BankAccount account)
       ...
       Tidak ada nilai kembalian. */
    public void addAccount(BankAccount account) throws IllegalStateException, NullPointerException {
        // Type your code
        if (account == null) {
            throw new NullPointerException("Akun tidak boleh null.");
        }
        if (count >= accounts.length) {
            throw new IllegalStateException("Batas maksimum akun telah tercapai.");
        }
    ...
    public BankAccount findAccount(String owner) {
        ...
        for (int i = 0; i < count && foundAccount == null; i++) {
